...
@4 = private unnamed_addr constant [11 x i8] c"src/test.c\00", align 1
...
define dso_local i32 @main() #0 !dbg !28 {
  ...
  call void @clexma_log_malloc_result(ptr %4, ptr @0, i32 6, ptr @1), !dbg !34
  call void @clexma_log_before_free_result(ptr %4, ptr @2, i32 6, ptr @3), !dbg !34
  call void @free(ptr noundef %4) #5, !dbg !34
    #dbg_declare(ptr %2, !35, !DIExpression(), !40)
    #dbg_declare(ptr %3, !41, !DIExpression(), !42)
  call void @clexma_log_after_free_result(ptr %4, ptr @4, i32 6, ptr @5), !dbg !43
  %5 = call noalias ptr @malloc(i64 noundef 8) #4, !dbg !43
  call void @clexma_log_malloc_result(ptr %5, ptr @6, i32 12, ptr @7), !dbg !44
  store ptr %5, ptr %3, align 8, !dbg !44
  %6 = load ptr, ptr %3, align 8, !dbg !45
  call void @clexma_log_before_free_result(ptr %6, ptr @8, i32 13, ptr @9), !dbg !46
  call void @free(ptr noundef %6) #5, !dbg !46
  call void @clexma_log_after_free_result(ptr %6, ptr @10, i32 13, ptr @11), !dbg !47
  %7 = call noalias ptr @malloc(i64 noundef 8) #4, !dbg !47
  call void @clexma_log_malloc_result(ptr %7, ptr @12, i32 14, ptr @13), !dbg !48
...
12:                                               ; preds = %0
  ...
  call void @clexma_log_before_free_result(ptr %13, ptr @14, i32 17, ptr @15), !dbg !56
  call void @free(ptr noundef %13) #5, !dbg !56
  call void @clexma_log_after_free_result(ptr %13, ptr @16, i32 17, ptr @17), !dbg !57
  br label %14, !dbg !57
